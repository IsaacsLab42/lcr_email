...
[Issues](https://github.com/IsaacsLab42/lcr_email/issues) that might help you.
...
- To see if other users have experienced (and potentially already solved) the
  ...
  tracker](https://github.com/IsaacsLab42/lcr_emailissues?q=label%3Abug).
...
- Open an [Issue](https://github.com/IsaacsLab42/lcr_email/issues/new). (Since
...
This section guides you through submitting an enhancement suggestion for LCR Email,
...
- Perform a [search](https://github.com/IsaacsLab42/lcr_email/issues) to see if
...
issues](https://github.com/IsaacsLab42/lcr_email/issues).
...
- **Explain why this enhancement would be useful** to most LCR Email users. You
...
The recommended way to use Poetry is to install it via `pipx`

```bash
pipx install poetry
```

If you don't wish to use `pipx` then you can install it using the official
installer:
